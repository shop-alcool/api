...
app.post('/alcool', function (req, res) {
    ...
    client.query('INSERT INTO alcohol(type_alcohol_id, name, price, quantity, description) VALUES($1, $2, $3, $4, $5) RETURNING *', [type_alcohol_id, name, price, quantity, description])
        .then(result => {
